...
namespace WEB2020.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public IActionResult orders([FromBody] OrderRequest orderRequest)
        {
            ...
            var result = _manage.giaodichManage.GetGiaodichwebs(orderRequest);
            return new JsonResult(result);
        }

        [HttpPost(Name = "ordersByTrangThai")]
        public IActionResult ordersByTrangThai([FromBody] OrderRequest orderRequest)
        {

            var result = _manage.giaodichManage.GetGiaodichwebsByTrangThai(orderRequest);
            return new JsonResult(result);
        }
